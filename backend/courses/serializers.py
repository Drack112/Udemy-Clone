...
class CourseSectionPaidSerializer(ModelSerializer):
    ...
    class Meta:
        model = CourseSection
        fields = ["section_title", "section_number", "episodes", "total_duduration"]
...
class CourseSectionUnPaidSerializer(ModelSerializer):
    ...
    class Meta:
        model = CourseSection
        fields = ["section_title", "section_number", "episodes", "total_duration"]
...
class CommentSerializer(ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ["user", "message", "created", "id"]
